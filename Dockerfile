...
ARG HELM_SECRETS_VERSION="4.6.5" # repo: jkroepke/helm-secrets
ARG HELM_GIT_VERSION="1.4.0" # repo: aslafy-z/helm-git
ARG KUBECTL_VERSION="1.33.3" # repo: kubernetes/kubernetes
ARG VALS_VERSION="0.41.3" # repo: helmfile/vals
ARG SOPS_VERSION="3.10.2" # repo: getsops/sops
ARG JQ_VERSION="1.6" # repo: jqlang/jq
ARG DOCTL_VERSION="1.134.0" # repo: digitalocean/doctl
